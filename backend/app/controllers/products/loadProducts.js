        ...
        const productCard = `
          <div class="card max-w-sm rounded overflow-hidden shadow-lg my-4 bg-slate-950" data-product-id="${product.id}">
            ...
            <div class="px-6 py-4">
              ...
              <p class="text-gray-500 text-base card-text-description">${product.descripcion}</p>
              <p class="text-gray-500 text-sm card-text-categoria">Categoría: ${product.categoria}</p>
              ...
              <div class="mt-4">
                ${data.rol == 'vendedor' ? `
                  <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2" onclick="editProduct(${product.id})">Editar</button>
                ...
                ` : `
                  <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ver Más</button>
                `}
              </div>
            </div>
          </div>
